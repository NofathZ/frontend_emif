<template>
  <div>
    <h1 class="heading-one" style="text-align: center; margin-bottom: 47px">Komisi BPMIF</h1>
    <p class="lead-two" style="text-align: center; margin-bottom: 203px">penjelasan singkat tentang apa itu Komisi</p>

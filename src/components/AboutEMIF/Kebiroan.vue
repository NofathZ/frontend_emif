<template>
  <div>
    <h1 class="heading-one" style="text-align: center; margin-bottom: 47px">Biro</h1>
    <p class="lead-two" style="text-align: center; margin-bottom: 203px">
      penjelasan singkat tentang apa itu biro
    </p>
    ...
    <div class="container">
      <div class="header-dept">
        <div class="header-img-box d-lg-none">
        ...
        <div class="header-content-box">
          <div class="header-explain-box">
            ...
            <p class="lead-four">
              ...
              FILKOM UB dan bertindak sebagai pengambil kebijakan tertinggi EMIF
              FILKOM UB.
            </p>
          </div>
          <div class="header-img-box d-none d-lg-block">
            <div class="img-box"></div>
          </div>
        </div>
      </div>
...
.other-dept {
  ...
  .box-other-dept {
    ...
    background-image: linear-gradient(
      ...
      url("https://s3-alpha-sig.figma.com/img/6197/648a/a17507e10af66c41354023e774067691?Expires=1630281600&Signature=cn8AplEB8tfA9e9qpydWkfuK5vR8J10LLp-24ok-AY2T4DhnkSMsakJpdfjh2f5JYPUCnLfOLuPgNUr1chbusX8dM4dIp5AvGWEPcJ8StVbMM410E3jQDtB6RDQYJqUl6-DgG0KXzxmf5Pp863Uc4kllnfNzM-6rsHx8xXgcB~4Ps53iDwVd5CQ4tVZchooFy4hweH80A13n~7oRI0cIha3YE99NnZotP3cY9D3R9seYQtMeWy6YxyCQpxR9ATTyktaeQvQa7NMzzZx4CHXvnwGPJx-e8SU2MTNx12Zyk7Lr-YHt5Y2thO2iY8Ir6jUEF~mKOfB88gnL8KiYKAeUhA__&Key-Pair-Id=APKAINTVSUGEWH5XD5UA");
    background-size: cover;
    background-position: center top;
    display: flex;
    justify-content: center;
